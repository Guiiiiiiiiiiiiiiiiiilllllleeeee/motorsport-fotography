	...
	*/
	const $noticeTopBar = {
		...
		init() {
			...
			if( !$.cookie('GuillermoNoticeTopBarClose') ) {
				self
					.build()
					.events();
			} else {
		...
		saveCookie() {
			...
			$.cookie('GuillermoNoticeTopBarClose', true);
...
(((theme = {}, $) => {
    ...
    class PluginGDPR {
        ...
        build() {
			...
			// Show
			if( !$.cookie( 'Guillermo-privacy-bar' ) ) {
				setTimeout(() => {
			...
			if( $.cookie( 'Guillermo-gdpr-preferences' ) ) {
				const preferencesArr = $.cookie( 'Guillermo-gdpr-preferences' ).split(',');
        ...
        events() {
			...
			$('.gdpr-preferences-form').on('submit', function(e){
				...
				$.cookie( 'Guillermo-privacy-bar', true, {expires: self.options.expires} );
				...
				setTimeout(() => {
					...
					setTimeout(() => {
						...
						if( $.cookie( 'Guillermo-gdpr-preferences' ) ) {
							...
							$.cookie( 'Guillermo-gdpr-preferences', formData, {expires: self.options.expires} );
							location.reload();
        ...
        clearCookies() {
			...
			$.removeCookie( 'Guillermo-privacy-bar' );
			$.removeCookie( 'Guillermo-gdpr-preferences' );
...
(((theme = {}, $) => {
    ...
    class PluginGDPRWrapper {
        ...
        build() {
			...
			if( $.cookie( 'Guillermo-gdpr-preferences' ) && $.cookie( 'Guillermo-gdpr-preferences' ).includes(self.options.checkCookie) ) {
